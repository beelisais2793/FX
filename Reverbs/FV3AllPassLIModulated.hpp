...
namespace FreeVerb3
{
    ...
    struct FV3AllPassFilterLIModulated : public FilterProcessorPlugin<fv3_allpassm>
    {
        FV3AllPassFilterLIModulated(size_t size, size_t msize, DspFloatType fbk, DspFloatType dcy) 
        ...
        {        
            DspFloatType r = this->process_li(I,X,Y);
            return A*r;
        }        
    };
}