...
namespace FreeVerb3
{
    ...
    struct FV3AllPassFilterDecay : public FilterProcessorPlugin<fv3_allpass>
    {
        FV3AllPassFilterDecay(size_t size, DspFloatType fbk, DspFloatType dcy) : FilterProcessorPlugin<fv3_allpass>()
        {
            this->setsize(size);
        ...
        DspFloatType Tick(DspFloatType I, DspFloatType A=1, DspFloatType X=1, DspFloatType Y=1)
        {
            ...
            this->setdecay(d*Y);
            DspFloatType r = this->process_dc(I);
            this->setfeedback(f);
            this->setdecay(d);
            return A*r;
        }        
