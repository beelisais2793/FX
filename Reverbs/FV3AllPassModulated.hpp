...
namespace FreeVerb3
{
    ...
    struct FV3AllPassFilterModulated : public FilterProcessorPlugin<fv3_allpassm>
    {
        FV3AllPassFilterModulated(size_t size, size_t msize, DspFloatType fbk, DspFloatType dcy) 
        ...
        {        
            DspFloatType r = this->process(I,X,Y);
            return A*r;
        }        
    };
}