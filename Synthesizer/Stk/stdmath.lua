...
ffi.cdev[[
    ...
    float modff (float y      , float x);
    long double modfl (long double y, long double x);
    ...
    long double powl (long double y, long double x);
    ...
    long double hypotl (long double y, long double x);

    double fmod  (double y     , double x);
    float fmodf (float y      , float x);
    long double fmodl (long double y, long double x);
