...
template<typename T>
MidiFileIn<T>::MidiFileIn( std::string fileName )
{
...
template<typename T>
void MidiFileIn<T>::rewindTrack( unsigned int track )
{
  if ( track >= nTracks_ ) {
...
template<typename T>
double MidiFileIn<T>::getTickSeconds( unsigned int track )
{
...
template<typename T>
unsigned long MidiFileIn<T>::getNextEvent( std::vector<unsigned char> *event, unsigned int track )
{
...
template<typename T>
unsigned long MidiFileIn<T>::getNextMidiEvent( std::vector<unsigned char> *midiEvent, unsigned int track )
{
...
template<typename T>
bool MidiFileIn<T>::readVariableLength( unsigned long *value )
{
