...
namespace stk {
    ...
    */
    ...
    inline void BandedWG :: clear( void )
    {
    ...
    inline void BandedWG :: setPreset( int preset )
    {
        int i;
        switch ( preset ) {
    ...
    inline void BandedWG :: setFrequency( StkFloat frequency )
    {
        #if defined(_STK_DEBUG_)
        if ( frequency <= 0.0 ) {
    ...
    inline void BandedWG :: setStrikePosition( StkFloat position )
    {
        strikePosition_ = (int)(delay_[0].getDelay() * position / 2.0);
    }

    inline void BandedWG :: startBowing( StkFloat amplitude, StkFloat rate )
    {
    ...
    inline void BandedWG :: stopBowing( StkFloat rate )
    {
        adsr_.setReleaseRate(rate);
        adsr_.keyOff();
    }

    inline void BandedWG :: pluck( StkFloat amplitude )
    {
        int j;
    ...
    inline void BandedWG :: noteOn( StkFloat frequency, StkFloat amplitude )
    {
    ...
    inline void BandedWG :: noteOff( StkFloat amplitude )
    {
        if ( !doPluck_ )
            this->stopBowing( (1.0 - amplitude) * 0.005 );
    }
    
    inline StkFloat BandedWG :: tick( unsigned int )
    {
        int k;
    ...
    inline void BandedWG :: controlChange( int number, StkFloat value )
    {
        #if defined(_STK_DEBUG_)
