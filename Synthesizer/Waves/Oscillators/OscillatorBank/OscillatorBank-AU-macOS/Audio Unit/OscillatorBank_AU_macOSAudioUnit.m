...
#import "OscillatorBank_AU_macOSAudioUnit.h"
...
@interface OscillatorBank_AU_macOSAudioUnit ()
...
@implementation OscillatorBank_AU_macOSAudioUnit
...
- (instancetype)initWithComponentDescription:(AudioComponentDescription)componentDescription options:(AudioComponentInstantiationOptions)options error:(NSError **)outError {
	...
	_kernelAdapter = [[OscillatorBank_AU_macOSDSPKernelAdapter alloc] init];
...
- (void)setupParameterCallbacks {
	...
	__block OscillatorBank_AU_macOSDSPKernelAdapter * kernelAdapter = _kernelAdapter;
