...
#import "OscillatorBank_AU_macOSDSPKernel.hpp"
#import "OscillatorBank_AU_macOSDSPKernelAdapter.h"

@implementation OscillatorBank_AU_macOSDSPKernelAdapter {
    // C++ members need to be ivars; they would be copied on access if they were properties.
    OscillatorBank_AU_macOSDSPKernel  _kernel;
...
- (AUInternalRenderBlock)internalRenderBlock {
    ...
    __block OscillatorBank_AU_macOSDSPKernel *state = &_kernel;
