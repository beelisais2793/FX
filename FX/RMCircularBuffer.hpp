...
//https://github.com/StudioSixPlusOne/rack-modules/blob/master/src/dsp/CircularBuffer.h
/*
...
public:
    ...
    inline T readBuffer (const DspFloatType delaySamples) const noexcept
    {
