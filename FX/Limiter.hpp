...
class Limiter {
    private:
        real SR = 48000.0; // Samplerate as a DspFloatType variable for later calculations.
        ...
        Filters::DelaySmooth<uint16_t, real> delay;
        ...
        Filters::ExpSmootherCascade<numberOfSmoothSections, real> expSmoother;
