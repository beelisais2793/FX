...
delayLengthSlider = vslider("h:/h:[1]Grain/ [3] Delay", 2, 0.5, 2, 0.1); // delay length in samples
pitchSlider = vslider("h:/h:[0]Granulator/ [1] Pitch", 1, -2, 2, 0.01); // pitch control (downsampling)
grainAmountSlider =  vslider("h:/h:[1]Grain/ [1] Density", 1, 1, MAXN, 1); // number of grains
positionspreadSlider = vslider("h:/h:[1]Grain/ [4] Spread", 1, 0.1, 2, 0.1); // position spread of grains
...
windowSlider = vslider("h:/h:[0]Granulator/ [2]Window[style:radio{'Sine Window':window1;'Hamming Window':window2;'Flat Top Window':window3}]",1,1,3,1);
