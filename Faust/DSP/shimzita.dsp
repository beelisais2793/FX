...
dry_wet = hslider("dry/wet", 0.5, 0,1, 0.05); //!!!Swap 1 in mixer()

process = _,_<:(_,_<:shimmizita_rev_fdn(f1,f2,t60dc,t60m, mode, shift,envelope,control,speed,depth,ps_dry_wet, fsmax):>_,_),_,_:_,X,_:mixer(1 - 1)
with {
	X = (_,_)<:(!,_,_,!);
