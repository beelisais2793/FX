...
struct VCS3DiodeFilter
{
    ...
    double C = 1.0e-7f;
    double Mp = 1.0e-4f;
    double biasParameter = 0.0f;
    double gainParameter = 1.0f;
    ...
    VCS3DiodeFilter(float sr = 44100.0f)
    {
        VC1 = 0.0f;
        VC2 = 0.0f;
        VC3 = 0.0f;
