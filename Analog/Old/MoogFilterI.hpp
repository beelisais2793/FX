...
namespace Analog::Filters::Moog::MoogFilterI
{
	...
	public:
		...
		void ProcessBlock(size_t n, float * input, float * output, int passMode = LOWPASS);
	...
	void MoogFilterI::ProcessBlock(size_t n, float * inputs, float * outputs, int passMode)
	{
